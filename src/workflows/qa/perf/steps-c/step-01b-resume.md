...
Detect the last completed step from a previously interrupted performance testing workflow, validate the state of generated artifacts, and resume execution from the next incomplete step.
...
- Detected configuration (stack, tool, endpoints)
...
3. For test scripts, check that they contain expected structures (thresholds, scenarios)
4. For CI config, check that it references the correct test scripts
...
|---|---|
| Step 1 (Preflight) | step-02-define-scenarios.md |
| Step 2 (Scenarios) | step-03-generate-scripts.md |
| Step 3 (Scripts) | step-04-thresholds-metrics.md |
| Step 4 (Thresholds) | step-05-ci-integration.md |
| Step 5 (CI) | step-06-validate-and-summary.md |
...
```
Performance Testing Workflow — Resume
