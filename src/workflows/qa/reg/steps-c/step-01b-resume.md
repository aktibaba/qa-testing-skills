---
name: 'reg-resume'
description: 'Resume an interrupted regression suite workflow'
nextStepFile: ''
...
Detect and resume from the last completed step of a previously interrupted regression testing workflow.
...
- Step 01 complete --> `{test_artifacts}/reg-preflight.md` exists
- Step 02 complete --> `{test_artifacts}/reg-categorization.md` exists
- Step 03 complete --> `{test_artifacts}/reg-suite-config.md` exists
- Step 04 complete --> `{test_artifacts}/reg-maintenance-plan.md` exists
- Step 05 complete --> `{test_artifacts}/reg-suite-summary.md` exists (workflow done)
...
- `step-02-categorize-tests` --> Load `steps-c/step-02-categorize-tests.md`
- `step-03-generate-regression-suite` --> Load `steps-c/step-03-generate-regression-suite.md`
- `step-04-maintenance-plan` --> Load `steps-c/step-04-maintenance-plan.md`
- `step-05-validate-and-summary` --> Load `steps-c/step-05-validate-and-summary.md`
...
Present a summary:
```
Resuming Regression Testing Workflow
- Completed: step-01 (preflight), step-02 (categorization)
- Resuming from: step-03 (suite generation)
- Artifacts verified: reg-preflight.md, reg-categorization.md
```
